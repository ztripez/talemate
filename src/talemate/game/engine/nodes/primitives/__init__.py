...
import talemate.game.engine.nodes.primitives.adventure  # noqa: E402,F401 - node registration side effect
...
import talemate.game.engine.nodes.primitives.render  # noqa: E402,F401 - node registration side effect
